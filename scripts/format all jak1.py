    ...
    for dirpath, _, filenames in os.walk(root_dir):
        for filename in filenames:
            if filename.endswith('.gc'):
                ...
                command = [
                    r"C:\Users\zedze\OneDrive\Documents\GitHub\fricked3-testing\out\build\Release\bin\formatter.exe",
                    "-w", "-f", gc_file_path
                ]
...
root_directory = r"C:\Users\zedze\OneDrive\Documents\GitHub\fricked3-testing\goal_src\jak3\engine\entity"
